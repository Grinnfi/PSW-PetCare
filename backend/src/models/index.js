...
const compraSchema = new Schema({
  ...
  donoNome: { type: String, default: '' },
  itens: [{
    produtoId: { type: Schema.Types.ObjectId, ref: 'Product' },
    nome:  String,
    qtd:   Number,
    preco: Number,
  }],
  ...
  pagamento: {
    forma:     { type: String, default: '' }, // credito, debito, pix, boleto
    nomCartao: { type: String, default: '' },
  },
...
const productSchema = new Schema({
  ...
  cat:          { type: String, required: true }, // tipo de produto: Alimentação, Higiene, Saúde, Acessórios
  categoriaPet: { type: String, enum: ['Cachorros','Gatos','Pássaros','Peixes','Outros Pets','Casa e Jardim'], default: 'Outros Pets' },
